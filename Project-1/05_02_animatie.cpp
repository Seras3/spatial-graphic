...
glm::mat4 myMatrix, resizeMatrix, matrTransl, matrScale1, matrScale2, matrRot, matrRot2, matrDepl; 
...
void RenderFunction(void)
{
  ...
  matrScale1=glm::scale(glm::mat4(1.0f), glm::vec3(2, 0.3, 0.0)); // folosita la desenarea dreptunghiului albastru
  ...
  matrRot2=glm::rotate(glm::mat4(1.0f), -angle, glm::vec3(0.0, 0.0, 1.0));
  ...
  myMatrix=resizeMatrix *  matrTransl * matrRot * matrDepl * matrRot2 * matrScale2;
  // Creare shader + transmitere variabile uniforme
  CreateShaders();
  myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix"); 
  glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE,  &myMatrix[0][0]);
